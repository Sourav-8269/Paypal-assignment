...
import { getData, updateData, deleteData } from "../Redux/App/action";
...
const EditTask = () => {
  ...
  // Getting Single Task from backend
  const getsingleTask = (id) => {
    axios
      .get(`https://real-blue-fly-wear.cyclic.app/tasks/single/${id}`)
      .then((res) => {
  ...
  // To store changed Data to local state
  ...
  return (
    ...
    >
      ...
      <Box display="flex" justifyContent="flex-end" mt="4%">
        ...
        <Button colorScheme="messenger" ml="3%" onClick={handelSubmit}>
          Edit
        </Button>
      </Box>
    </Box>
